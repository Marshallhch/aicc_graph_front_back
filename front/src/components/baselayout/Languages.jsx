...
const Languages = () => {
    ...
    const fetchCountryData = async () => {
      try {
        ...
        const sortedCountries = response.data.sort((a, b) => {
          // const alang = Object.keys(a.languages)[0];
          // const blang = Object.keys(b.languages)[0];
          return (
            (a.languages === b.languages) &
            a.name.common.localeCompare(b.name.name)
            // console.log(alang < blang)
          );
          //   ? a.languages.localeCompare(b.languages)
          //   : a.languages.localeCompare(b.languages); // 아니면 1번째 알파벳 오름차순
  ...
  // 자바스크립트 객체에서 키와 값이 같을 경우 키와 값중 하나만 쓸 수 있다.
